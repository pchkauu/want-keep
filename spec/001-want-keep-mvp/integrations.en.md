...
| Bybit | Funding USDT/USDC/ETH/BTC, used Easy Earn and P2P (D-36) | 2026-09-07: [research completed](evidence/bybit.en.md); Chrome and public Flexible APIs read. Official APIs preferred. | BLK-04: BYBIT-B02–B05 — private key/scopes, structured linkage/history, actual Earn and P2P eligibility/read method; task-0.10 → task-4.4. Other products deferred without blocking. |
