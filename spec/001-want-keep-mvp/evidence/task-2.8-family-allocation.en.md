...
The suite checks RUB, USD, USDT, USDC, BTC and ETH at arbitrary precision; 50/50, 60/40, exact amounts, deterministic remainder and mixed receipt `1000 → A 400 + B 600`. Item override, retained and recalculated purchase fallback, third-asset fee, unallocated, rule precedence/conflict/preview, confirmed merchant aliases without trusting provider IDs, no retrospective change, correction/undo/source protection, the complete review hash and one effect across matching evidence are covered.
