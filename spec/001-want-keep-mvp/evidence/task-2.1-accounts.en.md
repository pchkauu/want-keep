...
Review corrections cover confirmed raw currency aliases, atomic omission coverage across pages, skipped/repeated midnight and domain-owned event eligibility. Focused regressions accompany the fixes; publication and the subsequent review are bound to the updated candidate.
