...
Successful ValuationObservation responses require nonempty source legs in both generated clients. Synthetic BTC/RUB round trips preserve both CoinGecko and CBR observations, including the earlier effective date of the CBR rate and exact decimal values. Missing, empty, null and incomplete legs are rejected for reference and executed observations; unavailable valuations use their separate response variant.
