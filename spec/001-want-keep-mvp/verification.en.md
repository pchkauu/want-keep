...
[RU evidence](evidence/bybit.md) / [EN](evidence/bybit.en.md): D-36, BYBIT-E01–E10, exact official read-route matrix and [eight synthetic scenarios](evidence/bybit.samples.json). Funding/history, P2P/eligibility, API management and Earn inspected in Google Chrome. Six public GETs passed; no API keys and no authenticated calls. The current portal does not meet P2P advertiser prerequisites.

BYBIT-B01 closed; BYBIT-B02–B05 remain in BLK-04 under task-0.10. BYBIT-B06 and unused products do not block. Research is complete under README; task-4.4 and the MVP remain Not Ready. REQ-002/REQ-003/REQ-039/REQ-045 and AC/task IDs remain, with USDC added; AC-071/task-6.5 no longer require Bybit trading/mining. Bybit AC-070 is replaced by AC-033/AC-039 without credit-product requirements. Actual income, forecast and unknown Earn basis remain separate.

Local self review checks RU/EN meaning/IDs, directed movements, APR/time units, fees, replay, partial history and absence of personal data. The previous Avida pass does not cover this research. Final make docs-check, eight Decimal scenarios, links/diff and publication are checked on the exact candidate; outcomes and GitHub readback are recorded at delivery. Private API, full backfill, actual Earn flows, second owner/reauth/revocation, hourly collector and chosen VPS were not tested: key/contracts and financial runtime are absent. The task-1.1 foundation does not establish them.

Final candidate on base `cce4a4b`: `make docs-check` — pass, 14 generator tests — pass; 87 REQ / 105 AC / 67 tasks / 35 screens / 67 GitHub mappings. Eight synthetic Decimal/identity/coverage scenarios, RU/EN IDs/routes, unique decision IDs, exact catalog change scope and public-artifact scan — pass. Local self review completed; corrected ambiguous P2P-access wording and glossary-row formatting. Publication scope is separate from parallel Raif research.
