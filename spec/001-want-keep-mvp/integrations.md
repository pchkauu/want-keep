...
Срез публичной документации: 2026-09-06. Ни одна личная банковская/криптовалютная сессия не подключалась; live-доступ, полнота истории и покрытие продуктов не подтверждены. Наличие публичной документации или маркетингового описания не означает доступ к личному аккаунту.

## Обязательное покрытие

| Платформа | Продукты | Подтверждено публично | Открыто и задача |
| --- | --- | --- | --- |
| Альфа-Банк | Debit/credit cards, current/savings, deposits | Портал описывает API, в том числе данные счетов ФЛ. Описанный onboarding связан с договором/Альфа-Бизнес. | Eligibility личного пилота, scopes, все продукты, retail history/grace/quotes; task-0.1 → task-4.1. |
