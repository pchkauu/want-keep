...
| [REQ-045](requirements.md#req-045) | [AC-045](#ac-045), [AC-071](#ac-071) |
...
Учёт поддерживает RUB, USD, USDT, BTC и ETH; наличные, банковские деньги и платформенные кошельки различаются счетами.
...
Общую валюту отображения можно переключать между RUB, USD, USDT, BTC и ETH.
