...
Контракт проекта версии 4, целевой; семейное и desktop-уточнение 2026-09-07. Реальных API или схемы БД ещё нет. Здесь закреплены общие правила; provider-specific поля и условия закрываются task-0.1–task-0.10 до реализации. REQ/AC имеют приоритет над предположением адаптера.
