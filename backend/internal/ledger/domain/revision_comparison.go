...
func (r Revision) SameFacts(other Revision) bool {
	...
	for _, f := range []Field{PrincipalField, FeesField, DateField, PayerField, MerchantField, NoteField, AccountingField, CategoryField, MerchantIDField, ReceiptItemsField, MatchingField, AllocationField} {
