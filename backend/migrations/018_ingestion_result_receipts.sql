...
CREATE UNIQUE INDEX ingestion_result_receipts_evidence_idx ON want_keep.ingestion_result_receipts(household_id,job_id,lease_token,attempt,input_cursor,evidence_ref);
